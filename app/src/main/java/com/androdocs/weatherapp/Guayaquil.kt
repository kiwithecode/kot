...
class Guayaquil : AppCompatActivity() {

    val CITY: String = "GUAYAQUIL"
    val API: String = "37750f595babf6191069b38c35a7ebb1" // Use your own API key

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.guayaquil)
